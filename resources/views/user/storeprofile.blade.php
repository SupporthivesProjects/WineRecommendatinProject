                        ...
                        <div class="col-md-4 mt-4 mt-md-0">
                            <div class="card border-0 shadow-sm">
                                <div class="card-body">
                                    ...
                                    <p class="mb-2"><strong>Created At:</strong> {{ $store->created_at->format('F d, Y') }}</p>
                                    <p class="mb-2"><strong>Last Updated:</strong> {{ $store->updated_at->format('F d, Y h:i A') }}</p>
                                    <small class="text-muted d-block mt-3">
                                        All store information is used to manage and personalize operations efficiently.
                                    </small>
                                </div>
                            </div>
                        </div>
