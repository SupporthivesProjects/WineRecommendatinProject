...
<section class="filters-and-cards" id="products">
    <div class="container my-5">
        <div class="row g-2">
            ...
            <!-- Products Grid -->
            <div class="col-12 col-md-9 rounded p-3">
                <div class="row mb-4">
                        ...
                        <div class="d-flex flex-wrap gap-2 mb-3 align-items-center">
                            ...
                            <div class="ms-auto">
                                <div class="input-group">
                                    <input type="text" id="search-input" class="form-control" placeholder="Search wines...">
                            ...
                            @if ($type)
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input wine-type-filter" type="checkbox"
                                           value="{{ $lowerType }}" id="type-inline-{{ $lowerType }}" style="display:none;">
                    ...
                    <div class="col-12 col-lg-6 mb-3 filter-group wine-type-scroll">
                        ...
                        @php
                            ...
                            $methods = $allProducts->pluck('Method')->unique()->sort()->map(fn($m) => strtolower(trim($m)))->filter(fn($m) => in_array($m, $allowedMethods))->values();
                        @endphp
                        @foreach ($methods as $method)
                            ...
                            @endphp
                            <input type="checkbox" class="form-check-input wine-method-filter" value="{{ $method }}"
                                   id="method-inline-{{ $method }}" style="display:none;">
