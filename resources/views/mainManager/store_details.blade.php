                ...
                <div class="card-body">
                    ...
                    <div class="tab-content" id="storeTabContent">
                        ...
                        <div class="tab-pane fade" id="store-profiles">
                            ...
                            @include('partials.storeprofile-content')
                        </div>
                    </div>
                </div>
            </div>
            <script>
                document.querySelector('a[href="#store-profiles"]').addEventListener('shown.bs.tab', function() {
                    const tabContent = document.querySelector('#store-profiles');
                    if (!tabContent.dataset.loaded) {
                        fetch('{{ route('user.store-tab-profile.show') }}')
                            .then(res => res.text())
                            .then(html => {
