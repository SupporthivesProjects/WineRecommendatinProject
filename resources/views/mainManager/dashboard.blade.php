                            ...
                            <div class="card-item">
                                ...
                                <div class="card-item-title mb-2">
                                    <label class="main-content-label fs-13 fw-bold mb-1">Total
                                        Stores</label>
                                    <span class="d-block fs-12 mb-0 text-muted">Stores registered</span>
                                </div>
                                <div class="card-item-body">
                                    <div class="card-item-stat">
                                        <h4 class="fw-bold">{{ $storeCount }}</h4>
                    ...
                    <div class="card custom-card">
                        <div class="card-body">
                            <div class="card-item">
                                ...
                                <div class="card-item-body">
                                    <div class="card-item-stat">
                                        <h4 class="fw-bold">{{ $featuredProductCount }}</h4>
                        ...
                        <div class="card-body">
                            <div class="card-item">
                                ...
                                <div class="card-item-title mb-2">
                                    ...
                                    <span class="d-block fs-12 mb-0 text-muted">Total Products</span>
                                </div>
                                <div class="card-item-body">
                                    <div class="card-item-stat">
                                        <h4 class="fw-bold">{{ $allProductCount }}</h4>
                        ...
                        <div class="card-body">
                            <div class="card-item">
                                ...
                                <div class="card-item-title  mb-2">
                                    <label class="main-content-label fs-13 fw-bold mb-1">Total
                                        Sales</label>
                                    <span class="d-block fs-12 mb-0 text-muted">Bottles Sold</span>
                                </div>
                                <div class="card-item-body">
                                    <div class="card-item-stat">
                                        <h4 class="fw-bold">{{ $totalQuantitySold }}</h4>
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-xl-4">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <canvas id="mainManagerWineTypes" class="chartjs-chart"></canvas>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-8">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <canvas id="MainManagerchartjs-bar" class="chartjs-chart"></canvas>
                                </div>
                            </div>
                        </div>
...
@endif
    ...
    <script>
        ...
        const mywineChart = new Chart(
            document.getElementById('mainManagerWineTypes'),
            winetypeconfig
        );
    </script>
    ...
    <script>
        ...
        const mycountryChart = new Chart(
            document.getElementById('MainManagerchartjs-bar'),
            config44
        );
    </script>
   

    <!-- Total Sales DAta  - Bar Chart: Quantity Sold in Last 7 Days -->
    <script>
        ...
        const salesChartConfig = {
            ...
            data: {
                labels: salesLabels,
                datasets: [{
                    label: 'Quantity Sold (Last 7 Days)',
                    data: salesData,
                    backgroundColor: 'rgba(98, 89, 202, 0.6)',
        ...
        new Chart(
            document.getElementById('sales-last-7-days'),
            salesChartConfig
        );
    </script>

   <!-- Total Sales Chart Bar Chart: Total Sales Amount in Last 7 Days -->
    <script>
        const amountLabels = @json($amountLabels);
        const amountData = @json($amountData);
        ...
        const amountChartConfig = {
            ...
            data: {
                labels: amountLabels,
                datasets: [{
                    label: 'Total Sales Amount (Last 7 Days)',
                    data: amountData,
                    backgroundColor: 'rgba(241, 56, 139, 0.6)',
                    borderColor: 'rgb(241, 56, 139)',
                    borderWidth: 1,
                    hoverOffset: 4
                }]
            },
        ...
        new Chart(
            document.getElementById('sales-amount-7-days'),
            amountChartConfig
        );
    </script>
