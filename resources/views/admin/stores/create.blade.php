                    ...
                    <form method="POST" action="{{ route('admin.stores.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="licence_type" class="block mt-1 w-full" type="text" name="licence_type" :value="old('licence_type')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="gst_vat" class="block mt-1 w-full" type="text" name="gst_vat" :value="old('gst_vat')" />
