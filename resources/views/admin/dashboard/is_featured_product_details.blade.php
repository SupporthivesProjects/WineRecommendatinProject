    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                ...
                <div class="d-flex">
                <a href="{{ route('admin.isFeatured.index') }}" class="btn btn-wave btn-secondary my-2 btn-icon-text ms-2">
                            ...
                            <table id="file-export" class="table table-bordered" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-start">Product Pice</th>
                                            <th class="text-start">Created On</th>
                                            <th class="text-start">Updated On</th>
