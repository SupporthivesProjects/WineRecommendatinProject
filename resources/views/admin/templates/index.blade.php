    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                <div>
                    <h2 class="main-content-title fs-24 mb-1">Welcome To Templates Board</h2>
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.templates.create') }}" type="button" class="btn btn-wave btn-secondary my-2 btn-icon-text">
                        <i class="fe fe-plus me-2"></i> Add Template
                    </a>
                </div>
            </div>
            <!-- End::page-header -->
                                    ...
                                    <tbody>
                                        @forelse ($templates as $index => $template)
                                            <tr>
                                                ...
                                                <td class="align-middle">{{ $template->description }}</td>
