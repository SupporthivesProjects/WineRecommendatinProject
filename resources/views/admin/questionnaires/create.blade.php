<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Create Questionnaire Template') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('admin.questionnaires.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" name="name" type="text" value="{{ old('name') }}" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="is_active" name="is_active" class="mr-2" {{ old('is_active') ? 'checked' : '' }}>
            ...
            function addQuestion() {
                ...
                questionDiv.innerHTML = `
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="questions[${questionCount}][text]" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="slider-container hidden">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="questions[${questionCount}][min]" value="0" class="shadow appearance-none border rounded w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            </div>
                            <div>
                                <label class="block text-gray-700 text-sm font-bold mb-1 text-left">Max Value</label>
                                <input type="number" name="questions[${questionCount}][max]" value="100" class="shadow appearance-none border rounded w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            </div>
                            <div>
                                <label class="block text-gray-700 text-sm font-bold mb-1 text-left">Step</label>
                                <input type="number" name="questions[${questionCount}][step]" value="1" class="shadow appearance-none border rounded w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            </div>
                            <div>
                                <label class="block text-gray-700 text-sm font-bold mb-1 text-left">Default</label>
                                <input type="number" name="questions[${questionCount}][default]" value="50" class="shadow appearance-none border rounded w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                            </div>
                        </div>
                    </div>
                `;
