    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                <div>
                    <h2 class="main-content-title fs-24 mb-1">Create Cheese Product</h2>
                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        <div class="card-header">
                            <h4 class="card-title">Create New Cheese Product</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.cheese-products.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary me-2">
                                            <i class="fe fe-save me-2"></i>Create Product
                                        </button>
