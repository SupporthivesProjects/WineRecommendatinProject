<x-admin-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.products.edit', $product) }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition">
                Edit Product
            </a>
        </div>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="bg-white rounded-lg shadow overflow-hidden">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <p class="font-medium text-gray-900">{{ $product->wine_sub_region ?? 'N/A' }}</p>
                                    </div>
                                    
                                    <div class="mb-4">
                                        <p class="text-sm text-gray-600 mb-1">Retail Price</p>
                                        <p class="font-medium text-gray-900 text-lg text-indigo-600">${{ number_format($product->retail_price, 2) }}</p>
                                    </div>
                        ...
                        <div class="bg-gray-50 px-6 py-4 flex justify-end">
                            ...
                            <a href="{{ route('admin.products.edit', $product) }}" class="bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                Edit
                            </a>
                        </div>
                    </div>
