...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
            <div>
                <h2 class="main-content-title fs-24 mb-1">{{ __('Select Featured Products for Store') }}</h2>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Select Featured Products</li>
                </ol>
            </div>
            <div class="d-flex">
        ...
        <div class="py-5">
            <div class="container-lg">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mb-4">{{ __('Select Products to be marked as Featured Products') }}</h4>
