    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                ...
                <div class="d-flex">
                <a href="#" class="btn btn-wave btn-secondary my-2 btn-icon-text ms-2">
                                    ...
                                    <tbody>
                                        @forelse($submissions as $submission)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('store-manager.questionnaire.responses.show', $submission->submission_id) }}" class="btn btn-sm btn-primary">View</a>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
